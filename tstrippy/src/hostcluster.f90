...
CONTAINS
    ...
    SUBROUTINE query_current_kinematics(query_time)
        ...
        HOST_X_CURRENT = linear_interp_scalar(HOST_X(HOST_CURRENT_KINEMATICS_TIME_INDEX),&
                HOST_X(HOST_CURRENT_KINEMATICS_TIME_INDEX+1), alpha )
        HOST_Y_CURRENT = linear_interp_scalar(HOST_Y(HOST_CURRENT_KINEMATICS_TIME_INDEX),&
            HOST_Y(HOST_CURRENT_KINEMATICS_TIME_INDEX+1), alpha )
        HOST_Z_CURRENT = linear_interp_scalar(HOST_Z(HOST_CURRENT_KINEMATICS_TIME_INDEX),&
            HOST_Z(HOST_CURRENT_KINEMATICS_TIME_INDEX+1), alpha )
        HOST_VX_CURRENT = linear_interp_scalar(HOST_VX(HOST_CURRENT_KINEMATICS_TIME_INDEX),&
            HOST_VX(HOST_CURRENT_KINEMATICS_TIME_INDEX+1), alpha )
        HOST_VY_CURRENT = linear_interp_scalar(HOST_VY(HOST_CURRENT_KINEMATICS_TIME_INDEX),&
            HOST_VY(HOST_CURRENT_KINEMATICS_TIME_INDEX+1), alpha )
        HOST_VZ_CURRENT = linear_interp_scalar(HOST_VZ(HOST_CURRENT_KINEMATICS_TIME_INDEX),&
            HOST_VZ(HOST_CURRENT_KINEMATICS_TIME_INDEX+1), alpha )
